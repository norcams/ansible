...
sudo ansible-playbook -e "hosts=${host} patchfile=${HOME}/usr/share/openstack-dashboard/openstack_dashboard/dashboards/project/instances/tables.py" lib/patch.yaml

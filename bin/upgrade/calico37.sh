...
sudo ansible-playbook $opt -e "myhosts=${loc}-compute" lib/upgrade/calico37-compute.yaml
sudo ansible-playbook $opt -e "myhosts=${loc}-network" lib/upgrade/calico37-network.yaml
